...
screen -r @@Monit Name@@ -p 0 -X stuff "mono OpenSim.exe -hypergrid=true -inifile=\"./grid/@@Directory Name@@/OpenSim.ini\" -logconfig=\"./grid/@@Directory Name@@/OpenSim.exe.config\" -inidirectory=\"./grid/@@Directory Name@@\" $(printf '\r')"
